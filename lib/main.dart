...
class BuildingPermitDetailsPage extends StatelessWidget {
  const BuildingPermitDetailsPage({super.key});
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              hint: Text('Select Customer Class'),
                              items: ['Residential', 'Commercial', 'Industrial'].map((value) {
                              ...
                              onChanged: (value) {
                                print("Selected Customer Class: $value");
                              },
                            ),
                          ),
                        ],
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              hint: Text('Select Premise Type'),
                              items: ['Apartment', 'Villa', 'Plot'].map((value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value),
                                );
                              ...
                              onChanged: (value) {
                                print("Selected Premise Type: $value");
                              },
                            ),
                          ),
                        ],
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: ['New Connection', 'Upgrade', 'Temporary'].map((value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value),
                                );
